 ...
 * @author jerem
 */
public class ManejoArchivoCuota {
    public void GuardarDatos (String id_cuota,String fecha_cuota,String id_cliente,
          String valor_cuota,String status_cuota) throws IOException
    {
    
        try
        {
            FileWriter F1=new FileWriter("C:archivoCuota1.txt", true);
            PrintWriter pw=new PrintWriter(F1);
            pw.println(id_cuota + ";" + fecha_cuota + ";" + id_cliente 
    ...
    public void ModificaDatos(String LineaAntigua, String LineaNueva, String id_cuota )
    {
        
        File fNuevo= new File("C:archivoCuota2.txt");
        File fAntiguo= new File("C:archivoCuota1.txt");
        
       boolean encontrado = false;
        String aCadena=LineaAntigua;
        String nCadena=LineaNueva;
        int cod=Integer.parseInt(id_cuota); 
